...
public class BME280  {
	...
	public BME280() {
		try {
			...
			device = bus.getDevice(0x76); // Get I2C device, BME280 I2C address is 0x76(108)
		} catch (UnsupportedBusNumberException | IOException e) {
			e.printStackTrace();
		}
	}

	public EnvironmentSensorData pollEnvironmentSensor() {
		EnvironmentSensorData sensorData = null;
		try {
			...
			sensorData = new EnvironmentSensorData(fTemp, pressure, humidity);
		} catch (IOException e) {
			e.printStackTrace();
		}
		return sensorData;
